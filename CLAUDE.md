...
Core: `HIVE_MIND_DATA_DIR`, `HIVE_MIND_EMBEDDING_PROVIDER`, `HIVE_MIND_ROOT` (portable benchmark root), `HIVE_MIND_NO_SYNTH`, `HIVE_MIND_CONTRADICTION_OFF`, `HIVE_MIND_TIER`, `HIVE_MIND_CLI`, `HIVE_MIND_SQLITE_VEC_PATH`.
